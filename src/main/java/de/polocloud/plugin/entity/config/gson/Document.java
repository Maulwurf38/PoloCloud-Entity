package de.polocloud.plugin.entity.config.gson;
...
public class Document {
    ...
    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().registerTypeAdapter(Location.class, new LocationSerializer()).serializeNulls().create();
